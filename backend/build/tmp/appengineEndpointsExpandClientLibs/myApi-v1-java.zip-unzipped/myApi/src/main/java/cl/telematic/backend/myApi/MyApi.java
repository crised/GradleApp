 ...
 * on 2015-11-06 at 19:31:10 UTC 
 * Modify at your own risk.
 */

package cl.telematic.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class SayHi extends MyApiRequest<cl.telematic.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, cl.telematic.backend.myApi.model.MyBean.class);
  ...
  public class TellJoke extends MyApiRequest<cl.telematic.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "tellJoke/{name}";
